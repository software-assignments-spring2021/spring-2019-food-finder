            ...
            <form className={classes.root}>
              ...
              <Grid item xs={12}>
                <FormControl className={classes.formControl}>
                  ...
                  >
                    ...
                    <MenuItem value="Chinese/Japanese">
                      Chinese/Japanese
                    </MenuItem>
                    ...
                    <MenuItem value="Eastern European">
                      Eastern European
                    </MenuItem>
                    ...
                    <MenuItem value="Hotdogs/Pretzels">
                      Hotdogs/Pretzels
                    </MenuItem>
                    ...
                    <MenuItem value="Pancakes/Waffles">
                      Pancakes/Waffles
                    </MenuItem>
              ...
              <Grid item xs={12}>
                <FormControl className={classes.formControl}>
                  ...
                  >
                    <MenuItem value="No Preference">No Preference</MenuItem>
                    // for the below option, search for restaurants in the
                    user's zipcode area
